	...
	const fetchUserProfile = async () => {
		...
		try {
			...
			setUser({
				...
				image: "https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg", // Adjust based on API response
			});
		} catch (err) {
			setError(
